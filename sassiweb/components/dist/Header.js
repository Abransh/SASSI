            ...
            React.createElement("div", { className: "flex items-center justify-between" },
                React.createElement("div", { className: "flex items-center" },
                    React.createElement(link_1["default"], { href: "/#home", className: "font-bold text-2xl" },
                        React.createElement(image_1["default"], { src: "/assests/SASSI.png", alt: "Group Diwali Image", height: 200, width: 200, objectFit: "cover", className: "rounded-lg" }))),
                React.createElement("nav", { className: "hidden md:flex items-center space-x-6" },
                    ...
                    React.createElement(link_1["default"], { href: "#support-us", className: "text-gray-800 hover:text-primary transition-colors" }, "Support Us"),
