        ...
        React.createElement("div", { className: "container mx-auto px-4 relative z-10" },
            ...
            React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" },
                React.createElement("div", { className: "flex flex-col items-center" },
                    React.createElement(link_1["default"], { href: "/resources/before-arrival", className: "mb-4 bg-gray-900 text-white px-8 py-4 rounded-full font-bold hover:bg-gray-800 transition-colors" }, "BEFORE ARRIVAL"),
                    React.createElement("p", { className: "text-center text-gray-700" }, "Essential tips to prepare before you arrive in Italy.")),
                React.createElement("div", { className: "flex flex-col items-center" },
                    React.createElement(link_1["default"], { href: "/resources/living-in-milan", className: "mb-4 bg-gray-900 text-white px-8 py-4 rounded-full font-bold hover:bg-gray-800 transition-colors" }, "LIVING IN MILAN"),
                    React.createElement("p", { className: "text-center text-gray-700" }, "A guide to settling in and navigating life in Milan.")),
                React.createElement("div", { className: "flex flex-col items-center" },
                    React.createElement(link_1["default"], { href: "/resources/after-graduation", className: "mb-4 bg-gray-900 text-white px-8 py-4 rounded-full font-bold hover:bg-gray-800 transition-colors" }, "AFTER GRADUATION"),
