  ...
  const generalFAQs = [
    {
      ...
      answer:
        "You can join our association by filling out the membership form on our website or by attending one of our welcome events at the beginning of each semester. Membership is free for all Indian students studying in Milan.",
    },
    {
      question: "Are there any membership fees?",
      answer:
        "No, membership to the Indian Students' Association is completely free. We are funded through sponsorships, donations, and university grants.",
    },
    {
      question: "How often do you organize events?",
      answer:
        "We typically organize 2-3 major events each semester, including cultural celebrations, networking sessions, and academic workshops. We also host smaller meetups and gatherings throughout the year.",
    },
    {
      ...
      faqs: [
        {
          ...
          answer:
            "Milan has an excellent public transportation system including metro, trams, and buses. We recommend getting a monthly ATM pass (€39 for students) which gives unlimited access to all public transport within the city.",
        },
        {
      ...
      <div className="pt-32 pb-20">
        <div className="container mx-auto px-4">
          <div className="w-full md:w-[70%] mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold text-navy-800 mb-10 text-center">FAQs</h1>
