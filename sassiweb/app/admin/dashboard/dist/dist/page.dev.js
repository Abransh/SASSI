    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 3:
          ...
          , React.createElement("main", {
          ...
          }, "Admin Dashboard"), React.createElement("p", {
            className: "text-gray-600"
          }, "Welcome back, ", session.user.name || session.user.email)), React.createElement("div", {
            className: "grid grid-cols-1 md:grid-cols-2 gap-8 mb-12"
          }, React.createElement("div", {
            className: "bg-white rounded-lg shadow p-6"
          }, React.createElement("h2", {
            className: "text-xl font-bold mb-4"
          }, "Quick Stats"), React.createElement("div", {
            className: "grid grid-cols-2 gap-4"
          }, React.createElement("div", {
            className: "bg-orange-50 p-4 rounded-lg"
          }, React.createElement("p", {
            className: "text-sm text-gray-600"
          }, "Total Events"), React.createElement("p", {
            className: "text-2xl font-bold"
          }, events.length)), React.createElement("div", {
            className: "bg-green-50 p-4 rounded-lg"
          }, React.createElement("p", {
            className: "text-sm text-gray-600"
          }, "Published Events"), React.createElement("p", {
            className: "text-2xl font-bold"
            ...
            className: "text-sm text-gray-600"
          }, "New Messages"), React.createElement("p", {
            className: "text-2xl font-bold"
          }, contactSubmissions.filter(function (submission) {
            ...
            }, date_fns_1.format(new Date(event.startDate), "MMM d, yyyy")), React.createElement("td", {
              className: "px-4 py-3 text-sm text-gray-600"
          ...
          })))), events.length > 5 && React.createElement("div", {
            className: "p-4 border-t"
          }, React.createElement(link_1["default"], {
            href: "/admin/events",
            className: "text-orange-600 hover:text-orange-800"
          }, "View all events \u2192"))), React.createElement("div", {
            className: "bg-white rounded-lg shadow overflow-hidden"
          }, React.createElement("div", {
            className: "p-4 bg-gray-50 border-b"
          }, React.createElement("h2", {
            className: "text-xl font-bold"
          }, "Recent Contact Submissions")), React.createElement("div", {
            className: "divide-y divide-gray-200"
          }, contactSubmissions.slice(0, 3).map(function (submission) {
            ...
            }, submission.name), React.createElement("p", {
              className: "text-sm text-gray-600"
            }, submission.email)), React.createElement("span", {
              className: "text-xs text-gray-500"
            }, date_fns_1.format(new Date(submission.createdAt), "MMM d, yyyy"))), React.createElement("p", {
              className: "text-sm font-medium text-gray-700 mb-1"
            }, submission.subject), React.createElement("p", {
              className: "text-sm text-gray-600 line-clamp-2"
            }, submission.message));
          })), contactSubmissions.length > 3 && React.createElement("div", {
            className: "p-4 border-t"
          }, React.createElement(link_1["default"], {
            href: "/admin/contact",
            className: "text-orange-600 hover:text-orange-800"
          }, "View all messages \u2192"))))), React.createElement(Footer_1["default"], null))];
      }
    });
  });
}
