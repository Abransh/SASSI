...
function MembershipStatusActions(_a) {
    var _this = this;
    var requestId = _a.requestId, userId = _a.userId, currentStatus = _a.currentStatus, paymentVerified = _a.paymentVerified;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetch("/api/admin/membership-requests/" + requestId + "/status", {
                            method: "PATCH",
                            headers: {
                ...
                case 4:
                    sonner_1.toast.success("Membership request " + status.toLowerCase());
                    router.refresh();
                    return [3 /*break*/, 7];
                case 5:
                    error_1 = _a.sent();
    ...
    var handleVerifyPayment = function () { return __awaiter(_this, void 0, void 0, function () {
        var response, error, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!userId) {
                        sonner_1.toast.error("No user associated with this request");
                        return [2 /*return*/];
                    }
                ...
                case 1:
                    _a.trys.push([1, 5, 6, 7]);
                    return [4 /*yield*/, fetch("/api/admin/users/" + userId + "/verify-payment", {
                            method: "PATCH"
                        })];
                case 2:
                    response = _a.sent();
                ...
                case 4:
                    sonner_1.toast.success("Payment verified successfully");
                    router.refresh();
                    return [3 /*break*/, 7];
                case 5:
                    error_2 = _a.sent();
                    console.error("Error verifying payment:", error_2);
                    sonner_1.toast.error(error_2 instanceof Error ? error_2.message : "Failed to verify payment");
                    return [3 /*break*/, 7];
                case 6:
                    setIsLoading(null);
                    return [7 /*endfinally*/];
    ...
    if (currentStatus === "PENDING") {
        return (React.createElement("div", { className: "flex space-x-2" },
            !paymentVerified && userId && (React.createElement("button", { onClick: handleVerifyPayment, disabled: isLoading !== null, className: "p-1.5 rounded bg-blue-50 text-blue-600 hover:bg-blue-100", title: "Verify Payment" }, isLoading === "PAYMENT" ? (React.createElement(lucide_react_1.Loader2, { size: 16, className: "animate-spin" })) : (React.createElement(lucide_react_1.DollarSign, { size: 16 })))),
    ...
    return (React.createElement("div", { className: "flex space-x-2" },
        !paymentVerified && userId && currentStatus === "APPROVED" && (React.createElement("button", { onClick: handleVerifyPayment, disabled: isLoading !== null, className: "p-1.5 rounded bg-blue-50 text-blue-600 hover:bg-blue-100", title: "Verify Payment" }, isLoading === "PAYMENT" ? (React.createElement(lucide_react_1.Loader2, { size: 16, className: "animate-spin" })) : (React.createElement(lucide_react_1.DollarSign, { size: 16 })))),
        React.createElement("button", { onClick: handleViewDetails, disabled: isLoading !== null, className: "p-1.5 rounded bg-gray-50 text-gray-600 hover:bg-gray-100", title: "View Details" },
            React.createElement(lucide_react_1.ArrowRight, { size: 16 }))));
}
exports["default"] = MembershipStatusActions;
