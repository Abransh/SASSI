    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          , React.createElement("main", {
          ...
          }, "Manage Events"), React.createElement("p", {
            className: "text-gray-600"
          }, "Create, edit and manage all SASSI events")), React.createElement("div", {
          ...
          }, React.createElement(lucide_react_1.CalendarPlus, {
            size: 18,
            className: "mr-2"
            ...
            className: "w-1/3 py-4 px-1 text-center border-b-2 border-orange-500 font-medium text-orange-600"
          }, "Upcoming Events (", upcomingEvents.length, ")"), React.createElement("button", {
            className: "w-1/3 py-4 px-1 text-center border-b-2 border-transparent font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300"
          }, "Past Events (", pastEvents.length, ")"), React.createElement("button", {
            className: "w-1/3 py-4 px-1 text-center border-b-2 border-transparent font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300"
          }, "All Events (", events.length, ")"))), React.createElement("div", {
            ...
            className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"
          }, "Registrations"), React.createElement("th", {
            className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"
            ...
            }, event.description.substring(0, 60), "...")))), React.createElement("td", {
              className: "px-6 py-4 whitespace-nowrap"
            }, React.createElement("div", {
              className: "text-sm text-gray-900"
            }, date_fns_1.format(new Date(event.startDate), "MMM d, yyyy")), React.createElement("div", {
              className: "text-sm text-gray-500"
            }, date_fns_1.format(new Date(event.startDate), "h:mm a"), " -", date_fns_1.format(new Date(event.endDate), "h:mm a"))), React.createElement("td", {
              className: "px-6 py-4 whitespace-nowrap"
            }, React.createElement("div", {
              className: "text-sm text-gray-900"
            }, event.location)), React.createElement("td", {
              className: "px-6 py-4 whitespace-nowrap"
            }, React.createElement("div", {
              className: "text-sm text-gray-900"
            }, ((_a = event._count) === null || _a === void 0 ? void 0 : _a.registrations) || 0, event.maxAttendees && " / " + event.maxAttendees)), React.createElement("td", {
              className: "px-6 py-4 whitespace-nowrap"
            }, event.published ? React.createElement("span", {
            ...
            }, "Draft")), React.createElement("td", {
              className: "px-6 py-4 whitespace-nowrap text-right text-sm font-medium"
            }, React.createElement(link_1["default"], {
              href: "/events/" + event.id,
              className: "text-blue-600 hover:text-blue-900 mr-4"
            }, "View"), React.createElement(link_1["default"], {
              href: "/admin/events/" + event.id,
              className: "text-orange-600 hover:text-orange-900"
            }, "Edit")));
          }), upcomingEvents.length === 0 && React.createElement("tr", null, React.createElement("td", {
            colSpan: 6,
            className: "px-6 py-10 text-center text-gray-500"
          }, "No upcoming events.", React.createElement(link_1["default"], {
            href: "/admin/events/new",
            className: "text-orange-600 hover:text-orange-800 ml-1"
          }, "Create your first event"))))))))), React.createElement(Footer_1["default"], null))];
      }
    });
  });
}
