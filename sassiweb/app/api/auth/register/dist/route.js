...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, validatedData, existingUser, hashedPassword, user, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (existingUser) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: "User with this email already exists" }, { status: 400 })];
                    }
                ...
                case 5:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: "Failed to register user" }, { status: 500 })];
