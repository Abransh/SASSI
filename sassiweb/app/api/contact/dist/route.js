        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    // Send email notification
                    _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json({ message: "Contact form submitted successfully" }, { status: 201 })];
                case 4:
                    error_1 = _a.sent();
                    if (error_1 instanceof zod_1.z.ZodError) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: error_1.errors }, { status: 400 })];
                    }
                    console.error("Error submitting contact form:", error_1);
                    return [2 /*return*/, server_1.NextResponse.json({ error: "Failed to submit contact form" }, { status: 500 })];
